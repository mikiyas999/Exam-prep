...
export default function NewExamPage() {
  ...
  // Watch category changes to filter questions
  ...
  const fetchQuestions = async () => {
    ...
    try {
      ...
      params.append("limit", "50"); // Get more questions for selection
  ...
  async function onSubmit(values: z.infer<typeof formSchema>) {
    ...
    try {
      ...
      toast.success("create exam sucessfully");
  ...
  // Update question category filter when exam category changes
  useEffect(() => {
    if (watchedCategory) {
